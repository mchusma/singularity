  ...
  units: [
    {
      ...
      name: 'Scout Rocket',
      order: 1,
      resourceCost: [{ resourceId: 'money', quantity: 100 },{ resourceId: 'productionCapacity', quantity: 1 }],
      resourceOutput: [{ resourceId: 'tonsInSpace', quantity: 0.25 },{ resourceId: 'spaceCapacity', quantity: 0.25 }],
      unitCost: [],
      isVisible: true,
      quantity: 0,
      level: 0,
      ...
      },
      {
        ...
        resourceCostUpdate: [{ resourceId: 'money', quantity: 0.1 }],
        resourceCost: [{ unitId: 'money', quantity: 10000000000 }],
        resourceOutputUpdate: [{ resourceId: 'tonsInSpace', quantity: 100 },{ resourceId: 'spaceCapacity', quantity: 100 }],
        requiredUnits: [],
